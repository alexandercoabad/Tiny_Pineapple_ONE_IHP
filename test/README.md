...
Three extra testbenches cover the QSPI external-memory addition and are
...
# instructions against the external window (mem_test_ext.v swaps in a small
# test program in place of the production ROM demo)
