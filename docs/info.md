...
Five test suites cover different parts of this design (see `test/`):
...
model (`spi_ram_model.v`); and `tb_core_ext.v` closes the remaining gap
...
handshake, and `ui_in[7:3]` are free for whatever you bootload.
